...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 31, 2020 at 04:39 PM
...
(8, 'RITURAJ DABHOLE', '09923461213', 'hello', '2020-07-31 14:21:46', 'rituraj.dabhole20@gmail.com'),
(9, 'RITURAJ DABHOLE', '09923461213', 'nnnnnnnnnnnnnnnnnnnnnnnnnnnnn', '2020-07-31 14:28:10', 'rituraj.dabhole20@gmail.com'),
(10, 'RITURAJ DABHOLE', '09923461213', 'nnnnnnnnnnnnnnnnnnnnnnnnnnnnn', '2020-07-31 14:28:59', 'rituraj.dabhole20@gmail.com'),
(11, 'RITURAJ DABHOLE', '09923461213', 'nnnnnnnnnnnnnnnnnnnnnnnnnnnnn', '2020-07-31 14:42:42', 'rituraj.dabhole20@gmail.com');
...
(3, 'Variables4', 'fourth tagline', 'fourth-post', 'Beside filters, there are also so-called “tests” available. Tests can be used to test a variable against a common expression. To test a variable or expression, you add is plus the name of the test after the variable. For example, to find out if a variable is defined, you can do name is defined, which will then return true or false depending on whether name is defined in the current template context.\r\n\r\nTests can accept arguments, too. If the test only takes one argument, you can leave out the parentheses. For example, the following two expressions do the same thing:\r\n\r\n{% if loop.index is divisibleby 3 %}\r\n{% if loop.index is divisibleby(3) %}\r\nThe List of Builtin Tests below describes all the builtin tests.', 'bill.jpeg', '2020-07-31 14:18:34'),
(4, 'Whitespace Control', 'tagline', 'slug-next', 'In the default configuration:\r\n\r\na single trailing newline is stripped if present\r\nother whitespace (spaces, tabs, newlines etc.) is returned unchanged\r\nIf an application configures Jinja to trim_blocks, the first newline after a template tag is removed automatically (like in PHP). The lstrip_blocks option can also be set to strip tabs and spaces from the beginning of a line to the start of a block. (Nothing will be stripped if there are other characters before the start of the block.)\r\n\r\nWith both trim_blocks and lstrip_blocks enabled, you can put block tags on their own lines, and the entire block line will be removed when rendered, preserving the whitespace of the contents. For example, without the trim_blocks and lstrip_blocks options, this template:', 'post-bg.jpg', '2018-08-01 21:09:50'),
(5, 'List Comprehension, Dictionary Comprehension And Generator Comprehension | Advanced Python in Hindi', 'this is new post tagline', 'new-post', 'sfsf', 'sdf', '2018-08-04 17:20:16'),
(6, 'new bussiness idea', 'fastest growing bussiness', 'fast-growing-bussiness', 'asnasjdna dadoahdoia dudhanaodid', 'upload.jpg', '2020-07-31 11:45:34'),
(7, 'ritu', 'ritu', 'ritu', 'ritu', '<FileStorage', '2020-07-30 23:25:14'),
(8, 'new', 'rrrrrrr', 'fast-growing', 'hhijbygju', 'CertificateO', '2020-07-31 11:31:22');
